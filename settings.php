...
function fcwebmaintenance_option_meet_page()
{
  ...
  <p><a class="btn btn-primary btn-lg" href="mailto:nirob.std@gmail.com" role="button">Hire Me Now</a></p>
			...
			<div class="col-md-4"><h3>Contact Info</h3>
				<p>Email : <a href="mailto:themeix@gmail.com">themeix@gmail.com</a>
				
				
<br/>
				Marketplace : <a target="_blank"  href="http://www.themeix.com">Themeix</a><br/>
...
function fcwebmaintenance_option_page()
{
    ...
    $fcwebSettings['companylogo'] = "https://themeix.com/wp-content/uploads/2018/05/themeix-logo.png";
    ...
    $fcwebSettings['contactEmail'] = "themeix@gmail.com";
    $fcwebSettings['contactNumber'] = "1234567890";
    $fcwebSettings['facebookLink'] = "http://www.facebook.com/themeix";
    $fcwebSettings['twitterLink'] = "http://www.twitter.com/themeix_llc";
    $fcwebSettings['googleLink'] = "http://www.google.com/+themeix";
...
<input type="email" class="form-control"  placeholder="Email Address" name="contactEmail" id="contactEmail" value=\'' . $fcwebSettings['contactEmail'] . '\' />
    ...
    <div class="col-sm-10"><input type="text" class="form-control" placeholder="+1234567890"  name="contactNumber" id="contactNumber" value=\'' . $fcwebSettings['contactNumber'] . '\' />
    </div>
  </div> 
     <div class="form-group">
    <label for="facebookLink" class="col-sm-2 control-label">Facebook URL</label>
    <div class="col-sm-10"><input type="text" class="form-control" placeholder="http://facebook.com/themeix"  name="facebookLink" id="facebookLink" value=\'' . $fcwebSettings['facebookLink'] . '\' />
    </div>
  </div>  
     <div class="form-group">
    <label for="twitterLink" class="col-sm-2 control-label">Twitter URL</label>
    <div class="col-sm-10"><input type="text" class="form-control" placeholder="http://twitter.com/themeix_llc"  name="twitterLink" id="twitterLink" value=\'' . $fcwebSettings['twitterLink'] . '\' />
    </div>
  </div> 
      <div class="form-group">
    <label for="googleLink" class="col-sm-2 control-label">Google+ URL</label>
    <div class="col-sm-10"><input type="text" class="form-control" placeholder="http://google.com/+themeix"  name="googleLink" id="googleLink" value=\'' . $fcwebSettings['googleLink'] . '\' />
    </div>
  </div> 
  ...
  <div class="panel-body">
	...
	<label for="#" class="col-sm-2 "> <a class="btn btn-success" href="http://themeix.com" role="button"> Our Marketplace</a>
	</label>	
	...
	<label for="#" class="col-sm-2 "> <a class="btn btn-success" href="https://themeix.com/contact" role="button"> Hire Developer</a>
	</label>	
